      ...
      if (user) {
        try {
          ...
          const product = await axios.get(
            `https://myntra-clone-7wvc.onrender.com/order/user/${user._id}`,
          );
              ...
              <View style={styles.orderDetails}>
                ...
                <View style={styles.detailSection}>
                  <View style={styles.detailHeader}>
                    ...
                    <Text style={styles.detailTitle}>Shipping Information</Text>
                  </View>
                  <Text style={styles.detailText}>
                    Shipping Cost: ₹{order.shippingCost}
                  </Text>
                  <Text style={styles.detailText}>Tax: ₹{order.tax}</Text>
            ...
            <View style={styles.orderFooter}>
              <View style={styles.totalContainer}>
                ...
                <Text style={styles.totalAmount}>
                  ₹
                  {
                    // fallback to compute if backend value is missing/incorrect
                    order.total ||
                      (order.items || []).reduce(
                        (sum: number, i: any) =>
                          sum +
                          (i.price || i.productId.price) * (i.quantity || 1),
                        0,
                      ) +
